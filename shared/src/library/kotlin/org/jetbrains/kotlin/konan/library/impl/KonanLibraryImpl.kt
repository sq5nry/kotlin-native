...
class KonanLibraryImpl(
    ...
    override val wholeIr: ByteArray by lazy { layout.inPlace {  metadataReader.loadWholeIr(it) }}

    override fun irDeclaration(index: Long) = layout.inPlace { metadataReader.loadIrDeclaraton(it, index) }
